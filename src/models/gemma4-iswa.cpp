    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        if (hparams.has_kv(il)) {
            ...
            cur = build_attn(inp_attn, model.layers[il].wo,
                    nullptr, model.layers[il].wo_s, model.layers[il].wo_in_s, Qcur, Kcur, Vcur, nullptr, nullptr, nullptr,
                    hparams.f_attention_scale, il);
        } else {
            // reuse KV cache of earlier layers
            cur = build_attn(inp_attn,
                    model.layers[il].wo, nullptr, model.layers[il].wo_s, model.layers[il].wo_in_s,
        ...
        if (is_moe_layer) {
            ...
            cur_moe = build_moe_ffn(cur_moe,
                    ...
                    nullptr, // up_exps_in_s
                    nullptr, // gate_exps_in_s
