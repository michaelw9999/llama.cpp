...
ggml_tensor * llm_build_mamba_base::build_mamba_layer(llm_graph_input_rs * inp,
    ...
    ggml_tensor * xz = build_lora_mm(layer.ssm_in, cur, layer.ssm_in_s, layer.ssm_in_in_s);
    ...
    // ssm
    {
        ...
        cur = build_lora_mm(layer.ssm_out, y, layer.ssm_out_s, layer.ssm_out_in_s);
    }
...
ggml_tensor * llm_build_mamba_base::build_mamba2_layer(llm_graph_input_rs * inp,
    ...
    ggml_tensor * zxBCdt = build_lora_mm(model.layers[il].ssm_in, cur, model.layers[il].ssm_in_s, model.layers[il].ssm_in_in_s);
